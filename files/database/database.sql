...
-- Copiando estrutura para tabela anjos_crawler.category_subcategory
CREATE TABLE IF NOT EXISTS `category_subcategory` (
  `category_id` int(11) NOT NULL,
  `subcategory_id` int(11) NOT NULL,
  KEY `FKsfy4w610lbsb2137n9uceq2nn` (`subcategory_id`),
  KEY `FK7c0db84fbr3u8tkrqqq3p74fx` (`category_id`),
  CONSTRAINT `FK7c0db84fbr3u8tkrqqq3p74fx` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`),
  CONSTRAINT `FKsfy4w610lbsb2137n9uceq2nn` FOREIGN KEY (`subcategory_id`) REFERENCES `category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela anjos_crawler.category_subcategory: ~0 rows (aproximadamente)
